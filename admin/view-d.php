    ...
    <div class="col s12 m12 l9 offset-l3">
          <div class="row">
            ...
            <?php
              ...
              $em = $_GET['em'];
              $sel = $con->query("SELECT * FROM customer WHERE email = '$em'");
              if($sel->num_rows > 0){
            ...
            ?>
                ...
                <table class="table">
                    <tbody>
                      ...
                      <tr style="background:#fff;">
                        <td style="width: 170px">
                        <i style="color:black;font-size: 16px;">Home Address</i>
                        </td>
                        <td style="color:#000;font-size: 25px">
                      ...
                      <tr style="background:#fff;">
                        <td style="width: 170px">
                        <i style="color:black;font-size: 16px;">Delivery Address</i>
                        </td>
                        <td style="color:#000;font-size: 25px">
                        <i class="fa fa-arrow-right" style="color:black;font-size: 20px;"></i> <?=$f->delivery?>
                        </td>
                      </tr>

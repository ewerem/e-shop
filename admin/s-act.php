    ...
    <div class="col s12 m12 l9 offset-l3">
          <div class="row">
            ...
            <?php
              ...
              $sel = $con->query("SELECT * FROM order_g ORDER BY id DESC");
              if($sel->num_rows > 0){
             ...
             <table style="border-bottom: 1px solid #eee;">
               <tr>
                 ...
                 <td>
                   ...
                   <p></p>
                   <a href="view-ord.php?id=<?=$f->id?>&pid=<?=$f->pid?>" id="vd">view details</a>
                   <a href="s-act.php?rvo&id=<?=$f->id?>" id="vd" style="float: right;margin-right: 20px;margin-top: -10px;"><i class="fa fa-times" style="font-size: 16px;color: orange;"></i></a>
                 </td>
               </tr>
             </table>

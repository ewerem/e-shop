            ...
            <br/><br/><br/><br/><br/><br/>
             ...
             <div class="col s12 m12" style="height:auto;">
              ...
              <form method="post" enctype="multipart/form-data">
                  ...
                  <input id="last_name" name="grp" type="text" class="validate" style="color:gold;" required/>
                  <label for="last_name" style="color:#fff;">Add Product Group</label>
                  </div>
              ...
              <?php
                ...
                if(isset($_POST['sub'])){
                  ...
                  $ins = $con->query("INSERT INTO product_g VALUES(null, '$ecp', '$ecpg')");

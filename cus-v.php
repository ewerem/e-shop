	    	...
	    	<!-- Dropdown Structure -->
			  <ul id='dropdown1' class='dropdown-content' style="background:white;">
			    				 ...
			    				 <?php
					 			 ...
					 			 <li>
			    						<a href="cus-viewp.php" style="color:#990000;font-size:12px">
			    							all product
			    						</a>
			    					</li>
	 		...
	 		<div class="container-fluid">
		 		...
		 		<center>
			 		...
			 		<div class="row">
			 			...
			 			<?php
			 				$n = $_GET['pg'];
		                    $get = $con->query("SELECT * FROM product WHERE pgroup = '$n' ORDER BY id DESC");
		                    if($get->num_rows > 0){

		                    	echo'<center>
	 
						 			<h3 style="color:#fff;letter-spacing: 2px;padding: 5px;font-weight:bol;">
						 			- <i class="fa fa-gift"></i> '.strtoupper($_GET['pg']).' -
						 			</h3>
